...
<div className='fullDepositComponent'>
          ...
          <div className='depositSection'>
            ...
            <div className='depositFieldSection'><input onChange={(event) => dispatch(depositAmountActionCreater(event.target.value))} type='number' min="1" max="100000" placeholder='0.00' className='depositField'></input>  </div>
          </div>
